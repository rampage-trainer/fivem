        ...
        <div className="self-start mt-6 md:mt-10 flex flex-col gap-6">
            ...
            <div className="grid gap-4">
              <div className="flex items-center justify-between">
                <div className="space-y-1">
                  <div className="font-medium">FiveM</div>
                  <div className="text-muted-foreground">Build 1.0.2189.0 - 1.0.3717.0</div>
                </div>
          ...
          <div className="space-y-4">
            ...
            <div className="flex flex-wrap gap-3">
              <Link
                href="https://github.com/rampage-trainer/fivem/releases/latest/download/Rampage_FiveM.zip"
      ...
      <section className="grid gap-10 md:grid-cols-2 items-start">
        <div id="install" className="grid gap-6 max-w-prose w-full">
          ...
          <ol className="list-decimal list-outside pl-5 space-y-2 text-sm">
            ...
            <li>
              Copy <code>RampageFiles</code> and <code>Rampage.asi</code> into your plugins folder inside FiveM Application Data
            </li>
          </ol>
